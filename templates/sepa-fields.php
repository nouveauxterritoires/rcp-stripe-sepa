...
<fieldset class="rcp-stripe-sepa-fields">
	<legend class="screen-reader-text"><?php esc_html_e( 'Coordonnées bancaires', 'rcp-stripe-sepa' ); ?></legend>
